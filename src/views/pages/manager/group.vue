    ...
    <div>
        <div class="group">
            ...
            <div>
                ...
                <div class="group-card-container">
                    <div v-for="i in 15"  @click="detailGroupInfo(i)">
                        <group-card :data="{title:'测试000000群组'+i,member:i}"/>
                    </div>
                </div>
            </div>
            ...
            <el-dialog title="群组信息" :visible.sync="dialogVisible">
                <div style="font-size: 16px;margin: 8px 0 0 0;color: rebeccapurple">新项目测试</div>
                <div style="margin: 8px 0 8px 0;color:saddlebrown;">共{{ dialogGroupInfo }}人</div>
                <el-image :src="require('@/assets/fixyou.png')"></el-image>

            ...
            <co-card>
                <template v-slot:header>
                    <div class="create-header">
                        <co-text simple size="large">{{ params.title }}</co-text>
                        <co-text simple>结束时间：{{ DateFormatter(params.endTime, '/') }}</co-text>
                    </div>
                </template>
...
export default {
    ...
    components: {CoText, CoIcon, CoTip, CoCard},
    created() {
